    ...
    return (
        <main>
            ...
            <div className={styles.cards}>
                <Card title="Robotathon Steering Committee Fall 2024 Meeting Times: TBD!">
                    <p>To be determined!</p>
                </Card>

                <Card title="What is Robotathon Steering Committee?" className={styles.imageInCard}>
            ...
            <div className={styles.cards}>
                ...
                <Card title="When does Robotathon happen?">
                ...
                <Card title=" What do I need to know to participate?">
                ...
                <Card title="What is the time commitment like?">
                ...
                <Card title="I can’t make some event! What do I do?">
